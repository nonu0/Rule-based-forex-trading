        ...
        if start_time < time_utc < end_time:
            ...
            for symbol in symbols:
                ...
                try:
                    ...
                    try:
                            if current_four_trend == 'bullish' and current_one_trend == 'bullish' and current_ichimoku['Buy_Signal'] == 1:
                            ...
                            elif current_four_trend == 'bearish' and current_one_trend == 'bearish' and current_ichimoku['Sell_Signal'] == 1:
                    ...
                    logging.error('2:Connection to MetaTrader 5 server lost.')
                    time.sleep(5)
                    client.login()
                    ...
                    if position.symbol in symbols:
                        ...
                        if position.type == mt5.ORDER_TYPE_BUY:
                            ...
                            if current_price - entry_price >= pip_threshold:
                                new_sl = position.sl - trailing_stop_value * mt5.symbol_info(symbol).point
